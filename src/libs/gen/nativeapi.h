...
typedef void (*pkRegisterBuiltinFn_t)(PKVM*, const std::string&, pkNativeFn, int, const std::string&);
typedef void (*pkAddSearchPath_t)(PKVM*, const std::string&);
typedef void* (*pkRealloc_t)(PKVM*, void*, size_t);
typedef void (*pkReleaseHandle_t)(PKVM*, PkHandle*);
typedef PkHandle* (*pkNewModule_t)(PKVM*, const std::string&);
typedef void (*pkRegisterModule_t)(PKVM*, PkHandle*);
typedef void (*pkModuleAddFunction_t)(PKVM*, PkHandle*, const std::string&, pkNativeFn, int, const std::string&);
typedef PkHandle* (*pkNewClass_t)(PKVM*, const std::string&, PkHandle*, PkHandle*, pkNewInstanceFn, pkDeleteInstanceFn, const std::string&);
typedef void (*pkClassAddMethod_t)(PKVM*, PkHandle*, const std::string&, pkNativeFn, int, const std::string&);
typedef void (*pkModuleAddSource_t)(PKVM*, PkHandle*, const std::string&);
typedef PkResult (*pkRunString_t)(PKVM*, const std::string&);
typedef PkResult (*pkRunFile_t)(PKVM*, const std::string&);
typedef PkResult (*pkRunREPL_t)(PKVM*);
typedef void (*pkSetRuntimeError_t)(PKVM*, const std::string&);
...
typedef bool (*pkValidateSlotString_t)(PKVM*, int, std::string*);
...
typedef std::string (*pkGetSlotString_t)(PKVM*, int);
...
typedef void (*pkSetSlotString_t)(PKVM*, int, const std::string&);
typedef void (*pkSetSlotStringLength_t)(PKVM*, int, const std::string&);
...
typedef bool (*pkCallMethod_t)(PKVM*, int, const std::string&, int, int, int);
typedef bool (*pkGetAttribute_t)(PKVM*, int, const std::string&, int);
typedef bool (*pkSetAttribute_t)(PKVM*, int, const std::string&, int);
typedef bool (*pkImportModule_t)(PKVM*, const std::string&, int);
